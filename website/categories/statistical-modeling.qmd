...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderPackages(list) {
    ...
    for (var i = 0; i < Math.min(list.length, 50); i++) {
      ...
      html += '<a href="/packages/' + encodeURIComponent(pkg.package_name) + '">' + pkg.package_name + '</a>';
      html += '</h3>';
  ...
  // Load data
  Promise.all([
    fetch('../data/categories/statistical-modeling.json').then(function(r) { return r.json(); }),
