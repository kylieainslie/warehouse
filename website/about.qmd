...
|----------|------------------|
| [R-Universe](https://r-universe.dev) | Package metadata, binaries, and quality metrics |
| [CRAN](https://cran.r-project.org) | The official R package repository with 23,000+ packages |
| [GitHub](https://github.com) | R packages hosted on GitHub, discovered via the GitHub API |
